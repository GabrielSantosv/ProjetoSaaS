/* Fonte ÚNICA de verdade para leitura de valores monetários digitados.
   Carregado via <script src="./money.js"> no <helmet> das telas que têm
   campo de dinheiro. Não duplicar esta lógica dentro das telas.
...
(function (g) {
  ...
  g.AuroraMoney = { parseBRL: parseBRL, cents: cents, fromCents: fromCents };
